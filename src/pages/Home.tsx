  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative py-20 md:py-32 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-mentora-pink/30 via-mentora-blue/20 to-mentora-brightPink/10 -z-10" />
        <div className="absolute top-20 left-10 w-64 h-64 rounded-full bg-mentora-pink/20 blur-3xl -z-10 animate-float" />
        <div className="absolute bottom-20 right-10 w-80 h-80 rounded-full bg-mentora-blue/20 blur-3xl -z-10 animate-float" style={{ animationDelay: "1s" }} />
        
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="text-4xl md:text-6xl font-bold mb-6 bg-gradient-to-br from-mentora-text to-mentora-text/70 bg-clip-text text-transparent">
              Begin Your Journey to Mental Wellbeing
            </h1>
            <p className="text-lg md:text-xl text-mentora-subtext mb-8">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              ...
              <Link to="/conditions">
                <Button variant="outline" className="text-lg py-6 px-8 border-2 shadow-md">
      ...
      <section className="py-16 bg-white dark:bg-gray-900">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold mb-4">How Mentora Helps You</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-2xl text-center hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
              <div className="w-16 h-16 mx-auto mb-4 bg-mentora-pink/20 rounded-full flex items-center justify-center">
            ...
            <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-2xl text-center hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
              <div className="w-16 h-16 mx-auto mb-4 bg-mentora-blue/20 rounded-full flex items-center justify-center">
                <Heart className="text-mentora-blue" size={28} />
              </div>
              <h3 className="font-bold text-xl mb-3">Guided Therapy</h3>
              <p className="text-mentora-subtext">
            ...
            <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-2xl text-center hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
              <div className="w-16 h-16 mx-auto mb-4 bg-mentora-brightPink/20 rounded-full flex items-center justify-center">
                <Users className="text-mentora-brightPink" size={28} />
              </div>
              <h3 className="font-bold text-xl mb-3">Supportive Community</h3>
              <p className="text-mentora-subtext">
