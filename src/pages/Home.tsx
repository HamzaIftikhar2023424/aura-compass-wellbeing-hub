  ...
  return (
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <section className="relative py-20 md:py-32 overflow-hidden bg-white">
        <div className="absolute inset-0 bg-gradient-to-br from-mentora-pink/20 via-mentora-blue/10 to-mentora-brightPink/10 -z-10" />
        
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="text-4xl md:text-6xl font-bold mb-6 text-[#2F2F2F]">
              Begin Your Journey to Mental Wellbeing
            </h1>
            <p className="text-lg md:text-xl text-[#6E7E91] mb-8">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              ...
              <Link to="/conditions">
                <Button variant="outline" className="text-lg py-6 px-8 border-mentora-blue text-[#2F2F2F] hover:bg-mentora-blue/10">
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold mb-4 text-[#2F2F2F]">How Mentora Helps You</h2>
            <p className="text-[#6E7E91] max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white border border-mentora-pink/20 p-6 rounded-2xl text-center shadow-sm hover:shadow-md transition-all">
              <div className="w-16 h-16 mx-auto mb-4 bg-mentora-pink/10 rounded-full flex items-center justify-center">
                <Brain className="text-mentora-brightPink" size={28} />
              </div>
              <h3 className="font-bold text-xl mb-3 text-[#2F2F2F]">Personalized Assessment</h3>
            ...
            <div className="bg-white border border-mentora-blue/20 p-6 rounded-2xl text-center shadow-sm hover:shadow-md transition-all">
              <div className="w-16 h-16 mx-auto mb-4 bg-mentora-blue/10 rounded-full flex items-center justify-center">
                <Heart className="text-mentora-blue" size={28} />
              </div>
              <h3 className="font-bold text-xl mb-3 text-[#2F2F2F]">Guided Therapy</h3>
              <p className="text-[#6E7E91]">
                Access evidence-based therapeutic techniques, exercises, and resources personalized to your needs.
              </p>
            </div>
            
            <div className="bg-white border border-mentora-brightPink/20 p-6 rounded-2xl text-center shadow-sm hover:shadow-md transition-all">
              <div className="w-16 h-16 mx-auto mb-4 bg-mentora-brightPink/10 rounded-full flex items-center justify-center">
                <Users className="text-mentora-brightPink" size={28} />
              </div>
              <h3 className="font-bold text-xl mb-3 text-[#2F2F2F]">Supportive Community</h3>
              <p className="text-[#6E7E91]">
            ...
            <div className="bg-white border border-mentora-pink/20 p-6 rounded-2xl text-center shadow-sm hover:shadow-md transition-all">
              ...
              <h3 className="font-bold text-xl mb-3 text-[#2F2F2F]">Privacy First</h3>
              <p className="text-[#6E7E91]">
      ...
      <section className="py-16 bg-gray-50 dark:bg-gray-800">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-mentora-subtext max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white dark:bg-gray-900 p-8 rounded-2xl shadow-md">
              ...
              <p className="text-mentora-subtext mb-6 italic">
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-sm text-mentora-subtext">Using Mentora for 6 months</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-900 p-8 rounded-2xl shadow-md">
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-sm text-mentora-subtext">Using Mentora for 1 year</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-900 p-8 rounded-2xl shadow-md">
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-sm text-mentora-subtext">Using Mentora for 3 months</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-mentora-blue/30 via-mentora-pink/20 to-mentora-brightPink/30 -z-10" />
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Start Your Mental Health Journey Today
            </h2>
            <p className="text-lg text-mentora-subtext mb-8">
